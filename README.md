...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-19 17:31`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/881fb86d-866b-4716-b8b0-b7f22a4bc3a6.git
$ cd 881fb86d-866b-4716-b8b0-b7f22a4bc3a6
```
